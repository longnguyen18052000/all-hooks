...
const TodoList: FC = () => {
    ...
    const addTask = (): void => {
        const newTask = { username: username, email: email, password: password };
        ...
        <div className="w-full h-full flex flex-col justify-center items-center">
            ...
            <div className="w-[40%]">
                {todoList.map((task: TodoTask, key: number) => {
                    return <TodoListItem key={key} task={task} complateTask={complateTask} complateEdit={complateEdit} />
                })}
            </div>
